...
extension Date {
    ...
    var startCalendarWithPrefixDays: Date {
        let startOfMontWeekDay = Calendar.current.component(.weekday, from: startOfMonth)
        let numberOfPrefixDays = startOfMontWeekDay - 1
